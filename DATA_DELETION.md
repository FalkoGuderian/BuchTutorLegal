...
- App settings (language, model selection)
- PDF bookmarks
...
**External services:**
The app uses OpenRouter for AI processing. To manage or delete your OpenRouter account and data, visit [openrouter.ai/settings](https://openrouter.ai/settings).

No additional data is retained by us after deletion.
...
- Notizen und Lektionspläne
- App-Einstellungen (Sprache, Modellauswahl)
- PDF-Lesezeichen
...
**Externe Dienste:**
Die App nutzt OpenRouter für die KI-Verarbeitung. Um Ihr OpenRouter-Konto und Ihre Daten zu verwalten oder zu löschen, besuchen Sie [openrouter.ai/settings](https://openrouter.ai/settings).

Nach dem Löschen werden keine weiteren Daten von uns aufbewahrt.
